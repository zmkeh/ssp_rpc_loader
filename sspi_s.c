...
static const SERVER_ROUTINE DefaultIfName_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)Proc0_SspirConnectRpc,
    (SERVER_ROUTINE)Proc1_SspirDisconnectRpc,
    (SERVER_ROUTINE)Proc2_SspirDisconnectRpc,
    (SERVER_ROUTINE)Proc3_SspirCallRpc,
    (SERVER_ROUTINE)Proc4_SspirAcquireCredentialsHandle,
    (SERVER_ROUTINE)Proc5_SspirFreeCredentialsHandle,
    (SERVER_ROUTINE)Proc6_SspirProcessSecurityContext,
    (SERVER_ROUTINE)Proc7_SspirDeleteSecurityContext,
    (SERVER_ROUTINE)Proc8_SspirSslQueryCredentialsAttributes,
    (SERVER_ROUTINE)Proc9_SspirNegQueryContextAttributes,
    (SERVER_ROUTINE)Proc10_SspirSslSetCredentialsAttributes,
    (SERVER_ROUTINE)Proc11_SspirApplyControlToken,
    (SERVER_ROUTINE)Proc12_SspirLogonUser,
    (SERVER_ROUTINE)Proc13_SspirLookupAccountSid,
    (SERVER_ROUTINE)Proc14_SspirGetUserName,
    (SERVER_ROUTINE)Proc15_SspirGetInprocDispatchTable
    };
...
static const MIDL_SERVER_INFO DefaultIfName_ServerInfo = 
    ...
    lsass__MIDL_ProcFormatString.Format,
